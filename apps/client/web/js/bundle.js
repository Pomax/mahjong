...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = React.createClass({
	  ...
	  makeReady: function makeReady(gameid, handid, playerid, playerposition, score) {
	    ...
	    var state = { gameid: gameid, handid: handid, playerid: playerid, playerposition: playerposition, score: score, balance: '' };
	  ...
	  claimConcealedKong: function claimConcealedKong(tile) {
	    ...
	    return function (evt) {
	      _this5.log("requesting concealed kong for " + tile);
	      _this5.send("claim:concealedkong", { tile: tile });
	    };
	  },
	  ...
	  filterForBonus: function filterForBonus() {
	    ...
	    if (bonus.length > 0) {
	      this.setState({
	        ...
	        _this7.log("requesting compensation for", bonus.join(','));
	        _this7.send("compensate", { tiles: bonus });
	      });
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	module.exports = {
	  bind: function bind(socket, player) {
